...
public class JDBCTest {
	...
	//NEW USER
	/*@Test
	public void ValidateNewUserInfo() {
		app.currentUser = new User(10, "Leon", "Wilson", "LWILSON", "888-888-8888", "password");
		
		app.addMenu(NewUserMenu.getMenu());
		
		NewUserMenu m = (NewUserMenu) app.getCurrentMenu();
		assertTrue(m.validateInfo("Noel", "Nosliw", "NOSLIWL", "777-777-7777", "password1111", "password1111"));
	}*/
